// round1sm4.cpp : 此文件包含 "main" 函数。程序执行将在此处开始并结束。
//

/**************** testjunliu 11.10:simple SM4 (not optimize) *****************/
...
int main()
{
    ...
    uint32_t shuru[4] = { 0x01234567,0x89abcdef,0xfedcba98,0x76543210 };
    uint32_t shuchu[4], shuchu1[4], shuchu2[4], shuchu3[4], shuchu4[4];
    A1layer(shuru, shuchu);
    S1layer(shuchu, shuchu1);
    A2layer(shuchu1, shuchu2);
    S2layer(shuchu2, shuchu3);
    A3layer(shuchu3, shuchu4);
    printf("round 1 output is %08X,%08X,%08X,%08X\n", shuchu4[0], shuchu4[1], shuchu4[2], shuchu4[3]);
